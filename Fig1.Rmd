...
old_tree_plot(
    ...
    max_year = 2015,
    node_label = FALSE,
    edge_color_overide = "grey", #or "color" to set to tip color
    output_dir = "3_Output_Figures/3_5_DENV/3_5_1_Figure 1",
...
old_tree_plot(
    ...
    max_year = 2015,
    node_label = TRUE,
    edge_color_overide = NULL, #or "color" to set to tip color
    output_dir = "3_Output_Figures/3_5_DENV/3_5_1_Figure 1",
    filename = "Classical_Clades_plot_1965_nodelabel_DENV_%d.svg",
    width = 8,
    height = 5
)
...
new_tree_plot(
  dengue = 1:4, 
    ...
    max_year = 2015,
    output_dir = "3_Output_Figures/3_5_DENV/3_5_1_Figure 1",
    filename = "DENV%d_Tree_New_Clades_merged_%s.svg", 
    width = 8, 
    height = 5,
    palette_name = "Cross"
)
...
new_tree_plot(
  dengue = 1:4, 
    ...
    max_year = 2015,
    output_dir = "3_Output_Figures/3_5_DENV/3_5_1_Figure 1",
    filename = "DENV%d_Tree_New_Clades_merged_1965_%s.svg", 
    width = 8, 
    height = 5,
    palette_name = "Cross"
)
...
new_index_plot(
    ...
    max_year = 2015,
    output_dir = "3_Output_Figures/3_5_DENV/3_5_1_Figure 1",
    filename = "DENV%d_Index_New_Clades_merged_%s.svg", 
    width = 8, 
    height = 5,
    palette_name = "Cross")
...
new_index_plot(
    ...
    max_year = 2015,
    output_dir = "3_Output_Figures/3_5_DENV/3_5_1_Figure 1",
    filename = "DENV%d_Index_New_Clades_merged_1965_%s.svg", 
    width = 8, 
    height = 5,
    palette_name = "Cross")
