...
# Retrieve relevant variables
  ...
  svglite(filename = paste0("3_Output_Figures/","Classical_Clades_panel_plot_DENV_", i, ".svg"), width = 8, height = 10)
  par(mfrow = c(2, 1), oma = c(0, 0, 0, 0), mar = c(4, 4, 0, 0))
...
for (i in 1:4) {
  ...
  ggsave(
    filename = paste0("3_Output_Figures/","two_panel_plot_DENV_", i, ".svg"),
    plot = combined_plot,
    width = 8,
    height = 10,
  )
...
for (i in 1:4) {
  ...
  ggsave(filename = paste0("3_Output_Figures/","DENV_", i, "_", "Classical_vs_Phylowave_Clades_combined_plot_", st, ".svg"), plot = combined_plot, width = 12, height = 6)
