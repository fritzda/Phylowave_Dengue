...
breakpoints <- seq(1975, 2015, by = 0.5)
...
for (i in seq_along(serotypes)) {
  ...
  saveRDS(res_no_bp, file = paste0("4_Output_Data/", serotype_name, "_no_bp.rds"))
  ...
  for (bp in breakpoints) {
    cat("  └── Fitting breakpoint model at year:", bp, "\n")
  ...
  saveRDS(model_fits_bp, file = paste0("4_Output_Data/", serotype_name, "_bps.rds"))
...
for (i in 1:4) {
  ...
  png(filename = paste0("3_Output_Figures/fitness_plot_DENV_", i, "_" , st, min_year, ".png"), width = 1600, height = 1400, res = 300)
...
# Extract all results for this serotype
  ...
  # Plot
  png(filename = paste0("3_Output_Figures/fitness_plot_DENV_", i, "_bp_", best_year, "min_year", min_year, ".png"), width = 1600, height = 1400, res = 300)
