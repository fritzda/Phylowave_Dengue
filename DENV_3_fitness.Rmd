...
head(scores_DENV1_thai[[7]], 1)
glimpse(scores_DENV1_thai[[7]])

```

**For the association scores:**
...
# Retrieve relevant variables
  ...
  png(filename = paste0("3_Outputs/","Classical_Clades_panel_plot_DENV_", i, ".png"), width = 1800, height = 1800, res = 300)
  par(mfrow = c(2, 1), oma = c(0, 0, 0, 0), mar = c(4, 4, 0, 0))
...
max_groups_found_2 = 4
max_groups_found_1 = 10
...
```{r, eval = T}
potential_splits_3 = readRDS("3_Outputs/potential_splits_DENV3_timescale7_wind1_2025-01-06_2234.rds")
potential_splits_2 = readRDS("3_Outputs/potential_splits_DENV2_timescale7_wind1_2025-01-06_2234.rds")
potential_splits_1 = readRDS("3_Outputs/potential_splits_DENV1_timescale7_wind1_2025-01-06_2234.rds")
potential_splits_4 = readRDS("3_Outputs/potential_splits_DENV4_timescale7_wind1_2025-01-06_2234.rds")

st=format(Sys.time(), "%Y-%m-%d_%H%M")
##Write

# file_name_3 <- glue("3_Outputs/potential_splits_DENV3_timescale{timescale}_wind{wind}_{st}.rds")
# write_rds(potential_splits_3, file_name_3)
# 
# file_name_2 <- glue("3_Outputs/potential_splits_DENV2_timescale{timescale}_wind{wind}_{st}.rds")
# write_rds(potential_splits_2, file_name_2)
# 
# file_name_1 <- glue("3_Outputs/potential_splits_DENV1_timescale{timescale}_wind{wind}_{st}.rds")
# write_rds(potential_splits_1, file_name_1)
# 
# file_name_4 <- glue("3_Outputs/potential_splits_DENV4_timescale{timescale}_wind{wind}_{st}.rds")
...
for (i in 1:4) {
  ...
  ## Dynamically store the index plot
  assign(paste0('index_plot_', i), index_plot)
}
...
for (i in 1:4) {
  ...
  ggsave(filename = paste0("3_Outputs/","combined_plot_DENV_", i, ".png"), plot = combined_plot, width = 12, height = 6, dpi = 300)
  ...
  htmlwidgets::saveWidget(interactive_plot, file = paste0("3_Outputs/","interactive_plot_DENV_", i, ".html"))
}
...
options(mc.cores = 8) #Set to 8 cores
start_time = Sys.time()
...
```{r, eval = T}
# res_fitness_1 = readRDS("3_Outputs/res_fitness_DENV1_timescale7_wind1_2025-01-06_2234.rds")
# res_fitness_2 = readRDS("3_Outputs/res_fitness_DENV2_timescale7_wind1_2025-01-06_2234.rds")
# res_fitness_3 = readRDS("3_Outputs/res_fitness_DENV3_timescale7_wind1_2025-01-06_2234.rds")
# res_fitness_4 = readRDS("3_Outputs/res_fitness_DENV4_timescale7_wind1_2025-01-06_2234.rds")




# #Write
# file_name_fitness_3 <- glue("3_Outputs/res_fitness_DENV3_timescale{timescale}_wind{wind}_{st}.rds")
# file_name_fitness_2 <- glue("3_Outputs/res_fitness_DENV2_timescale{timescale}_wind{wind}_{st}.rds")
# file_name_fitness_1 <- glue("3_Outputs/res_fitness_DENV1_timescale{timescale}_wind{wind}_{st}.rds")
# file_name_fitness_4 <- glue("3_Outputs/res_fitness_DENV4_timescale{timescale}_wind{wind}_{st}.rds")
...
for (i in 1:4) {
  ...
  png(filename = paste0("3_Outputs/fitness_plot_DENV_", i, ".png"), width = 1600, height = 1400, res = 300)
...
for (i in 1:4) {
  ...
  png(filename = paste0("3_Outputs/observed_vs_predicted_DENV_", i, ".png"), width = 1400, height = 16600, res = 300)
  
  # Re-plot to save it within the PNG file
  plot_observed_vs_predicted(
    data = res_fitness$data,
    Chains = res_fitness$chains,
    colour_lineage = colour_lineage
...
for (i in 1:4) {
  ...
  png(filename = paste0("3_Outputs/estimated_fitness_ref_ancestral_DENV_", i, ".png"), width = 1200, height = 800, res = 300)
