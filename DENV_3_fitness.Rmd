...
for (serotype in names(results)) {
  ...
  png(filename = paste0("3_Output_Figures/breakpoint_plot_DENV_", serotype, "_" , st, min_year, ".png"), width = 1600, height = 1400, res = 300)
...
for (i in 1:4) {
  ...
  png(filename = paste0("3_Output_Figures/fitness_plot_DENV_", i, "_" , st, "_min_year_", min_year, ".png"), width = 1600, height = 1400, res = 300)
...
# Extract all results for this serotype
  ...
  # Plot
  png(filename = paste0("3_Output_Figures/fitness_plot_DENV_", i, "_bp_", best_year, "_min_year_", min_year, ".png"), width = 1600, height = 1400, res = 300)
