...
Saving the Potential Splits
```{r save splits, }


for (d in 1:4){
  
  potential_splits = get(sprintf("potential_splits_%d", d))
  splits_file_name <- glue("4_Output_Data/Max_groups_potential_splits_DENV{d}_timescale{timescale}_wind{wind}_{st}.rds")
...
```{r linlog group plot}
max_groups_found_line_3 = 6
max_groups_found_line_2 = 3
max_groups_found_line_1 = 8
max_groups_found_line_4 = 2
