...
for (d in 1:4) {
  ...
  #old code
  sapply(names_seqs_3, function(x) str_split(x, pattern = '_')[[1]][3])
...
# Retrieve relevant variables
  ...
  svglite(filename = paste0("3_Output_Figures/3_5_DENV/3_5_1_Figure 1/","Classical_Clades_plot_DENV_", d, ".svg"), width = 8, height = 5)
  ...
  svglite(filename = paste0("3_Output_Figures/3_5_DENV/3_5_1_Figure 1/","Classical_Index_plot_DENV_", d, ".svg"), width = 8, height = 5)
  par(mfrow = c(1, 1), oma = c(0, 0, 0, 0), mar = c(4, 4, 0, 0))
  ## Index plot
  ...
  svglite(filename = paste0("3_Output_Figures/3_5_DENV/3_5_1_Figure 1/","Classical_Clades_and_Index_panel_plot_DENV_", d, ".svg"), width = 8, height = 10)
